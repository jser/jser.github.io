...
JSer.info #705 - - [Announcing Rspack 1.0 - Rspack](https://rspack.dev/blog/announcing-1-0)
- [Migrating from Rspack 0.x - Rspack](https://rspack.dev/guide/migration/rspack_0.x)

---

- [Release Notes for Safari Technology Preview 202 | WebKit](https://webkit.org/blog/15798/
