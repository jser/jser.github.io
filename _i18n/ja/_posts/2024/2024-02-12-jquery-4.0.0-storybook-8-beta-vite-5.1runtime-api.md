...
JSer.info #680 - - [jQuery 4.0.0 BETA! | Official jQuery Blog](https://blog.jquery.com/2024/02/06/jquery-4-0-0-beta/)
...
- [Vite 5.1 is out! | Vite](https://vitejs.dev/blog/announcing-vite5-1.html)
  - [Vite Runtime API | Vite](https://vitejs.dev/guide/api-vite-runtime)
