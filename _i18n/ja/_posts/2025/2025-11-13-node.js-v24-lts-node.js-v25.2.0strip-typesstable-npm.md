---
title: "2025-11-13のJS: Node.js v24 LTS、Node.js v25.2.0(Strip typesがStable)、npmのセキュリティアップデート"
author: "azu"
layout: post
date: 2025-11-13T02:34:46.058Z
category: JSer
tags:
- nodejs
- React
...
Type Stripping機能がStableとなリマした。
これにより、TypeScriptファイルを直接実行する際に型情報を自動的に削除する機能が正式にサポートされます。
また、`util.deprecate`に`modifyPrototype`オプションが追加され、プロトタイプの変更を制御できるようになりました。
...
Ink v6.5.0リリース。
`incrementalRendering`オプションを追加し、差分だけをレンダリングできるように
