...
npmの[Require two-factor authentication and disallow tokens](https://docs.npmjs.com/requiring-2fa-for-package-publishing-and-settings-modification)の設定について書かれています。
