---
title: "2022-08-18のJS: Astro 1.0、Node.js 16.17.0、DenoとBun"
author: "azu"
layout: post
...
JSer.info #605 - - [Astro 1.0 | Astro](https://astro.build/blog/astro-1/)
...
- [Bun is a fast all-in-one JavaScript runtime](https://bun.sh/)
  - [Node と Deno と Bun | marmooo's blog](https://marmooo.blogspot.com/2022/07/node-deno-bun.html?m=1)
    - [perf(ext/ffi): JIT compiler for FFI by littledivy · Pull Request #15006 · denoland/deno](https://github.com/denoland/deno/pull/15006)
    - [Why is Deno that slow? · Discussion #15121 · denoland/deno](https://github.com/denoland/deno/discussions/15121)
      - [Optimize atob/btoa by using `base64-simd` · Issue #14980 · denoland/deno](https://github.com/denoland/deno/issues/14980)
      - [data processing performance compared to Safari / Chrome / NodeJS / Deno · Issue #406 · oven-sh/bun](https://github.com/oven-sh/bun/issues/406)
        - [denoland/deno_graph: The module graph logic for Deno CLI](https://github.com/denoland/deno_graph)
