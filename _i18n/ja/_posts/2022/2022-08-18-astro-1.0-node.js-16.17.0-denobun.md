...
これらの変更予定は、[Node.js compability mode](https://deno.land/manual@v1.17.2/npm_nodejs/compatibility_mode)など元から検討されていた部分の延長という部分もありますが、[Bun](https://bun.sh/)との機能的/ベンチマーク的な比較などを意識している部分もありそうです。
