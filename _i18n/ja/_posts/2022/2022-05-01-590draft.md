...
<p class="jser-tags jser-tag-icon"><span class="jser-tag">Survey</span> <span class="jser-tag">web </span> <span class="jser-tag">JavaScript</span> <span class="jser-tag">CSS</span></p>
