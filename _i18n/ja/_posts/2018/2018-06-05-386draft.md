...
<p class="jser-tags jser-tag-icon"><span class="jser-tag">CSS</span> <span class="jser-tag">editor</span> <span class="jser-tag">Tools</span></p>

CSS AnimationのGUIエディタ。
CSS Animtationのプロパティを設定して、実際にアニメーションとして再生しながら変化するプロパティを決めたCSSを出力できる
