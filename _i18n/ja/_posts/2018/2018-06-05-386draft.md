...
[sucrase](https://github.com/alangpierce/sucrase)というTypeScript、Flow、JSXと一部のES.nextの機能の変換に限定したTranspilerが公開されています。

- Online playground: [Sucrase](https://sucrase.io/)
...
そのため、BabelのようなASTプラグインはサポートしていませんが、実行ステップが少なくなるため高速な変換を行えます。
