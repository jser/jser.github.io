...
JSer.info #546 - - [Ecma International approves new standards - Ecma International](https://www.ecma-international.org/news/ecma-international-approves-new-standards-4/)
- [ES2021に対応したJavaScript Primer 3.0を公開しました - JavaScript入門 | Web Scratch](https://efcl.info/2021/06/28/jsprimer-3.0/)
- [Release 3.0.0: ECMAScript 2021対応 · asciidwango/js-primer](https://github.com/asciidwango/js-primer/releases/tag/v3.0.0)
- [Storybook 6.3](https://storybook.js.org/blog/storybook-6-3/)
- [Storybook for Vite](https://storybook.js.org/blog/storybook-for-vite/)
- [Comparing develop...jser-week-546 · jser/jser.github.io](https://github.com/jser/jser.github.io/compare/jser-week-546?expand=1&short_path=6929d6b)
