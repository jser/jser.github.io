...
Same-Siteかどうかは[Public Suffix List](https://publicsuffix.org/)を元に決めるため、Bitbucket(bitbucket.io)に関してはPublic Suffix Listに加えることでCross-Siteとことでこの問題を防いでいます。
...
また拡張機能のPage(`chrome-extension://`)における問題は、Chrome 92で拡張同士はSame-Siteとは関係なくプロセスを共有しないことでこの問題が修正されています。
