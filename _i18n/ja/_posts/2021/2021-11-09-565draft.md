...
## Performance Tracing · microsoft/TypeScript Wiki
[github.com/microsoft/TypeScript/wiki/Performance-Tracing](https://github.com/microsoft/TypeScript/wiki/Performance-Tracing "Performance Tracing · microsoft/TypeScript Wiki")
<p class="jser-tags jser-tag-icon"><span class="jser-tag">TypeScript</span> <span class="jser-tag">performance</span> <span class="jser-tag">debug</span></p>

TypeScriptの`generateTrace`フラグを使ったトレースデータのプロファイルについて。
型チェック時のボトルネック調査方法
