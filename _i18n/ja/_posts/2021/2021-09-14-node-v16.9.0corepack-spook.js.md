---
title: "2021-09-14のJS: Node v16.9.0(Corepack)、Spook.js(クロスサイトでのサイドチャネル攻撃)"
author: "azu"
layout: post
...
JSer.info #557 - - [Node v16.9.0 (Current) | Node.js](https://nodejs.org/en/blog/release/v16.9.0/)
- [Corepack | Node.js v16.9.1 Documentation](https://nodejs.org/dist/latest-v16.x/docs/api/corepack.html)
- [V8 release v9.3 · V8](https://v8.dev/blog/v8-release-93)

----

- [Spook.js](https://www.spookjs.com/)
