...
Origin Trialとして、Service Workerのmanifestの[`capture_links`](https://github.com/WICG/sw-launch/blob/main/declarative_link_capturing.md)、[WebTransport](https://w3c.github.io/webtransport/)、WebXR Plane Detection API。
