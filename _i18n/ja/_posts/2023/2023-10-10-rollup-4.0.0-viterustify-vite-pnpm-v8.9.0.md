...
JSer.info #664 - - [Release v4.0.0 · rollup/rollup](https://github.com/rollup/rollup/releases/tag/v4.0.0)

---

- [State of Vite (ViteConf 2023) - Google スライド](https://docs.google.com/presentation/d/1oZnjsPBnb3OB2HxU88vYkZLa54GV-xNKrF8XkOIqLAU/mobilepresent#slide=id.g286269c24aa_0_219)
...
- [rolldown-rs](https://github.com/rolldown-rs/)

----

- [Release v8.9.0 · pnpm/pnpm](https://github.com/pnpm/pnpm/releases/tag/v8.9.0)
  - [Fix file cloning on macOS · Issue #5001 · pnpm/pnpm](https://github.com/pnpm/pnpm/issues/5001)
