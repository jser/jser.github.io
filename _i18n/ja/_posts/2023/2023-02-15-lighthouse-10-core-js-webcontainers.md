...
（オープンソース）ソフトウェアを購入する動機は減っている一方で、その社会的価値は劇的に上昇していて、多くの人やサイトはオープンソースソフトウェアに依存しています（[モダンなウェブアプリのコードの97%はnpmからきている](https://medium.com/npm-inc/this-year-in-javascript-2018-in-review-and-npms-predictions-for-2019-3a3d7e5298ef#49d6)という話があります）。
