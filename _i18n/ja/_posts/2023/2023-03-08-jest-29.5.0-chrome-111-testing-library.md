...
JSer.info #634 - - [Release v29.5.0 · facebook/jest](https://github.com/facebook/jest/releases/tag/v29.5.0)
...
- [Sentry’s Frontend Tests: Migrating from Enzyme to React Testing Library | Product Blog • Sentry](https://blog.sentry.io/2023/02/23/sentrys-frontend-tests-migrating-from-enzyme-to-react-testing-library/)
