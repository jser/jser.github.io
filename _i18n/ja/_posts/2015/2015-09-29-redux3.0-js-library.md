...
[v3.0.1](https://github.com/rackt/redux/releases/tag/v3.0.1 "v3.0.1")ではデバッグ時のみ`combineReducers()`で登録したミドルウェアが変換する度にState Treeの形をチェックするようになり、おかしな変換が起きたことを検知しやすくなっています。
