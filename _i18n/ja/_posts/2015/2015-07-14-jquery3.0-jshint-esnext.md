---
title: "2015-07-14のJS: jQuery 3.0α、JSHintとES next"
author: azu
layout: post
...
[また以前断念したrequestAnimationFrameによるアニメーション](http://blog.jquery.com/2011/09/01/jquery-1-6-3-released/)がjQuery 3.0では有効化されています。
