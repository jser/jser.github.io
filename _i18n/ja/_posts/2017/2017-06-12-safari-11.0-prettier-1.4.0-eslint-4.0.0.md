...
また、Mobile Safariや[Chrome for Android](https://developers.google.com/web/updates/2016/07/autoplay "Chrome for Android")で導入されていた、音があるMediaの自動再生制限がmacOSのSafariにも導入されています。
