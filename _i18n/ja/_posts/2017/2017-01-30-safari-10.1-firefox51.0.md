...
JSer.info #315 - [Safari 10.1](https://developer.apple.com/library/prerelease/content/releasenotes/General/WhatsNewInSafari/Articles/Safari_10_1.html "Safari 10.1")がリリースされました。
...
アプローチとして型をつけていきながらリファクタリングをしていく際にFlowTypeやTypeScriptを使ったときの問題点やそれぞれのツールではどのような方法が用意されているかについて書かれています。

Flowではweak modeを使った方法やTypeScriptでは`.js`を`.ts`に変更するところからなど、どのように徐々に型をつけていったかについて書かれています。
最終的にTypeScriptを利用した際に遭遇した型のエラーなどについてもかかれているので呼んでみると面白いかもしれません。
