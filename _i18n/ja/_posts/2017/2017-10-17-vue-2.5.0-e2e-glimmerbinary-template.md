...
ランタイムはバイナリを[ArrayBuffer](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer "ArrayBuffer")で読み込んでてんぷーと情報を作り、DOMを組み立てるようになるため、ファイルサイズやパース速度などが改善されるかもしれません。
