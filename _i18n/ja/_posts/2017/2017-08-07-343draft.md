...
現在αリリースされているbabel-preset-env 2.0αについて。
静的解析した結果のpolyfillだけを読み込む`"useBuiltIns": "usage"`の解説と挙動について。

- [Discussion: useBuiltIns (usage only, not &#34;entry&#34; point method) · Issue #284 · babel/babel-preset-env](https://github.com/babel/babel-preset-env/issues/284 "Discussion: useBuiltIns (usage only, not &amp;#34;entry&amp;#34; point method) · Issue #284 · babel/babel-preset-env")
