---
title: "2014-11-17のJS: IE11のES6サポート、Jasmine 2.1.0、TypeScript 1.3"
author: azu
layout: post
...
JSer.info #202 - [Windows 10](http://blogs.windows.com/bloggingwindows/2014/11/12/new-build-available-to-the-windows-insider-program/ "Windows 10")の新しいプレビュー版が公開されたため、IE11のプレビュー版もアップデートされました。
...
`“living” Edge document mode`というのが導入されて、IE11ではデフォルトがこのEdgeモードがデフォルトになります。
...
また、IEのUA判定をして挙動を変えるサイトがあるため、IE11ではUAも異なるものとなっています。
