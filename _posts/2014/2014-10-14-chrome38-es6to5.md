...
また、開発者ツールに[Device Mode &amp; Mobile Emulation](https://developer.chrome.com/devtools/docs/device-mode "Device Mode &amp; Mobile Emulation - Google Chrome")という機能が追加されています。
